...
final class TimeTableViewModel: ObservableObject {
    ...
    var tableCalendar = [String: [TableItem]]()
    ...
    @Published var indexDay = [Int: String]()
    ...
    private func calToTableCal(_ cal: Calendar) -> [String: [TableItem]] {
        var tableCalendar = [String: [TableItem]]()
    ...
    private func getCalendar() async -> Calendar {
        ...
        let last = DateUtil.formattedDayToDate(selectedDay.last!).addingTimeInterval(86400)
